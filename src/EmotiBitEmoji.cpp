...
EmotibitEmoji::EmotibitEmoji(void)
{
 ...
 */
void EmotibitEmoji::drawEmoji(uint8_t emojiTemplate, uint8_t orientation, uint8_t intensity, uint8_t xPos, uint8_t yPos, uint8_t width, uint8_t height)
{
